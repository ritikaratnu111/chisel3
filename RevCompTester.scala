...
/**
  ...
  * }}}
  */
object RevCompMain extends App {
  iotesters.Driver.execute(args, () => new RevComp) {
    c => new RevCompTest(c)
  }
}
...
/**
  ...
  * }}}
  */
object RevCompRepl extends App {
  iotesters.Driver.executeFirrtlRepl(args, () => new RevComp)
}
